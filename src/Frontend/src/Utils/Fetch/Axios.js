...
export const PostFood = "https://localhost:1000/api/FoodSeller"
export const GetPurchaseFoods = "https://localhost:1000/api/FoodSeller"
export const DeleteFood = "https://localhost:1000/api/FoodSeller?id="
